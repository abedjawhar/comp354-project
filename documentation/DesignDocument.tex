...
\hline
\textbf{Class Name}                  & \multicolumn{4}{l|}{com.github.comp354project.service.Account}                                                                                                                        \\ \hline
...
\multirow{6}{*}{\textbf{Attributes}} & \textbf{Visibility} & \textbf{Data Type}                                & \textbf{Name}    & \textbf{Description}                                                                     \\ \cline{2-5} 
                                     & private             & Integer                                           & ID               & \begin{tabular}[c]{@{}l@{}}bank account \\ identification number\end{tabular}            \\ \cline{2-5} 
                                     & private             & String                                            & type             & \begin{tabular}[c]{@{}l@{}}type of bank account \\ (chequing, savings, ect)\end{tabular} \\ \cline{2-5} 
                                     & private             & Double                                            & balance          & Amount inside the account                                                                \\ \cline{2-5} 
                                     & private             & User                                              & user             & name of the user                                                                         \\ \cline{2-5} 
                                     & private             & ForeignCollection\textlessTransaction\textgreater & transactions     & transaction object                                                                       \\ \hline
...
\textbf{Description}                 & \multicolumn{4}{l|}{\begin{tabular}[c]{@{}l@{}}Class used to request information from thebank database \\ in order to add \\ or delete an account to myMoney application\end{tabular}}              \\ \hline
\multirow{5}{*}{\textbf{Attributes}} & \textbf{Visibility} & \textbf{Data Type}                          & \textbf{Name}        & \textbf{Description}                                                                                     \\ \cline{2-5} 
                                     & private             & Logger                                      & logger               & \begin{tabular}[c]{@{}l@{}}logger object \\ attribute \\ used to keep \\ track \\ of errors\end{tabular} \\ \cline{2-5} 
                                     & private             & Dao\textlessTransaction,Integer\textgreater & transactionDao       & \begin{tabular}[c]{@{}l@{}}Dao object \\ used to query the \\ database\end{tabular}                      \\ \cline{2-5} 
                                     & private             & Dao\textlessUser,Integer\textgreater        & userDao              & \begin{tabular}[c]{@{}l@{}}Dao object \\ used \\ for \\ quering \\ the database\end{tabular}             \\ \cline{2-5} 
                                     & private             & IRemoteAccountService                       & remoteAccountService & \begin{tabular}[c]{@{}l@{}}attribute \\ used to access \\ database\end{tabular}                          \\ \hline
\multirow{6}{*}{\textbf{Methods}}    & \textbf{Visibility} & \textbf{Name}                               & \textbf{Returns}     & \textbf{Description}                                                                                     \\ \cline{2-5} 
                                     ...
                                     & public              & addAccount                                  & Account              & \begin{tabular}[c]{@{}l@{}}request \\ bank \\ information \\ from the \\ database\end{tabular}           \\ \cline{2-5} 
                                     & public              & deleteAccount                               & void                 & \begin{tabular}[c]{@{}l@{}}delete \\ a particular \\ account from \\ myMoney \\ application\end{tabular} \\ \cline{2-5} 
                                     & public              & transform                                   & Account              & \begin{tabular}[c]{@{}l@{}}create\\ the appropriate \\ banking info \\ to display for\end{tabular}       \\ \cline{2-5} 
                                     & public              & Transaction                                 & transform            & \begin{tabular}[c]{@{}l@{}}create \\ the \\ appropriate \\ transaction \\ info to display\end{tabular}   \\ \hline
\end{tabular}
\end{table}
...
\multirow{3}{*}{\textbf{Methods}}    & \textbf{Visibility} & \textbf{Name}             & \textbf{Returns}   & \textbf{Description}                                                           \\ \cline{2-5} 
                                     & public              & provideTransactionService & transactionService & \begin{tabular}[c]{@{}l@{}}return \\ transactionService \\ Object\end{tabular} \\ \cline{2-5} 
                                     & public              & provideAccountService     & accountService     & \begin{tabular}[c]{@{}l@{}}returns \\ accountService \\ Object\end{tabular}    \\ \hline
\end{tabular}
\end{table}
...
\multirow{4}{*}{\textbf{Attributes}} & \textbf{Visibility} & \textbf{Data Type}                          & \textbf{Name}     & \textbf{Description}                                                                                    \\ \cline{2-5} 
                                     & private             & Logger                                      & logger            & \begin{tabular}[c]{@{}l@{}}object used to interact \\ with \\ TransactionService \\ class\end{tabular}  \\ \cline{2-5} 
                                     & private             & Dao\textlessTransaction,Integer\textgreater & transactionDao    & \begin{tabular}[c]{@{}l@{}}object used to \\ perform \\ methods \\ related to transactions\end{tabular} \\ \cline{2-5} 
                                     & private             & ICategoryNameValidator                      & categoryValidator & \begin{tabular}[c]{@{}l@{}}object used to \\ validate \\ if a \\ category is correct\end{tabular}       \\ \hline
\multirow{3}{*}{\textbf{Methods}}    & \textbf{Visibility} & \textbf{Name}                               & \textbf{Returns}  & \textbf{Description}                                                                                    \\ \cline{2-5} 
                                     & public              & TransactionService                          & N/A               & constructor                                                                                             \\ \cline{2-5} 
                                     & public              & updateTransactionCategory                   & Transaction       & \begin{tabular}[c]{@{}l@{}}used to update a \\ specific\\ transaction\end{tabular}                      \\ \hline
\end{tabular}
\end{table}
