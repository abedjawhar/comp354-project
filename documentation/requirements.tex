...
\begin{usecase}{Delete User Account}
    ...
    \addrow{User Story} {"As a user, I want to be able to delete my account because i might not want to use this app anymore later in the future "}
    % \addrow{Scope}{money and budget management application}
    % \addrow{Level}{user-goal}
    % \addrow{Actors}{\textbf{User}}
    % \addmulrow{Stakeholders and Interests}{
...
\begin{usecase}{Remove Bank Account from a User Account}
    ...
    \addrow{User Story} {"As a user,I want to be able to remove a bank account because if i'm no longer registered with them then there is no point in still keeping their info"}
    % \addrow{Scope}{money and budget management application}
    % \addrow{Level}{user-goal}
    % \addrow{Actors}{\textbf{User}}
    % \addmulrow{Stakeholders and Interests}{
...
\begin{usecase}{View Transactions for Specific Bank Account}
  ...
  \item Company: Wants to give user ability to micromanage every aspect of the application down to each bank account and transaction.}
    ...
    \addrow{User Story} {"As a user,I want to be able view certain transactions because i want to budget more efficiently "}
    \addmulrow{Main Success Flow}{
...
\begin{usecase}{View All Transactions from all Bank Accounts}
    ...
    \addrow{User Story} {"As a user,I want to be able view all transactions because i want to budget more efficiently "}
    \addmulrow{Main Success Flow}{
...
\begin{usecase}{View Transaction by Type}
    ...
    \addrow{User Story}{"As a user, i want to be able to view where my money is going because i can pinpoint which type of transactions i make the most"}
    % \addrow{Scope}{money and budget management application}
    % \addrow{Level}{user-goal}
    % \addrow{Actors}{\textbf{User}}
    % \addmulrow{Stakeholders and Interests}{
...
\begin{usecase}{Categorize Transaction}
    ...
    \addrow{User Story}{"As a user, i want to be able to sort my transactions based on types because it would be easier for me to see them all"}
    % \addrow{Scope}{money and budget management application}
    % \addrow{Level}{user-goal}
    % \addrow{Actors}{\textbf{User}}
    % \addmulrow{Stakeholders and Interests}{
...
\begin{usecase}{View Transactions by Category}
    ...
    \addrow{Summary}{User can view transaction according to categories of spending.}
     \addrow{User Story} {"As a user, i want to be able to view where most of money because i want to budget more efficiently "}
    % \addrow{Scope}{money and budget management application}
    % \addrow{Level}{user-goal}
    % \addrow{Actors}{\textbf{User}}
    % \addmulrow{Stakeholders and Interests}{
