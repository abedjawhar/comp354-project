...
\begin{usecase}{View Transaction for Specific Bank Account}
    \addrow{Case ID}{05}
  ...
  \item Company: Wants to give user ability to micromanage every aspect of the application down to each bank account and transaction.}
    \addrow{Pre-Conditions}{User has added one or more bank accounts to his myMoney account. }
...
\begin{usecase}{View All Transactions}
    \addrow{Case ID}{06}
    ...
    \addrow{Pre-Conditions}{Account has been created and one or more bank accounts have been added to the system.}
...
\begin{usecase}{View Transactions by Category}
    ...
    \addrow{Pre-Conditions}{User has made transactions and labeled the transaction according to which category it belongs.}
